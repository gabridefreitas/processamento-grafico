...
// Essencial para computadores da Apple
  ...
  GLFWwindow *window = glfwCreateWindow(
      WIDTH, HEIGHT, "Hello Colorful Triangle!", nullptr, nullptr);
  ...
  Shader shader("hello-triangle-glm/hello-triangle.vs",
                "hello-triangle-glm/hello-triangle.fs");
  ...
  glm::mat4 projection =
      glm::ortho(-10.0f, 100.0f, -10.0f, 100.0f, -1.0f, 1.0f);
